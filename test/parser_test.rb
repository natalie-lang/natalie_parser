  ...
  describe parser do
    ...
    describe '#parse' do
      ...
      it 'parses while/until' do
        ...
        expect(parse('while foo > bar do end')).must_equal s(:while, s(:call, s(:call, nil, :foo), :>, s(:call, nil, :bar)), nil, true)
        ...
        expect(parse('until foo > bar do end')).must_equal s(:until, s(:call, s(:call, nil, :foo), :>, s(:call, nil, :bar)), nil, true)
