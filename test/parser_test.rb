  ...
  describe parser do
    ...
    describe '#parse' do
      ...
      it 'parses strings' do
        ...
        expect(parse('"#{foo { 1 }}"')).must_equal s(:block, s(:dstr, "", s(:evstr, s(:iter, s(:call, nil, :foo), 0, s(:lit, 1)))))
        expect(parse(%q("#{1}foo#{''}bar"))).must_equal s(:block, s(:dstr, '', s(:evstr, s(:lit, 1)), s(:str, 'foo'), s(:str, ''), s(:str, 'bar')))
        expect(parse(%q('foo' 'bar'))).must_equal s(:block, s(:str, 'foobar'))
        expect(parse(%q('foo' "bar"))).must_equal s(:block, s(:str, 'foobar'))
        expect(parse(%q("foo" 'bar'))).must_equal s(:block, s(:str, 'foobar'))
        expect(parse(%q("foo" "bar"))).must_equal s(:block, s(:str, 'foobar'))
        ...
        expect(parse(%q(%Q{1 {2} 3}))).must_equal s(:block, s(:str, "1 {2} 3"))
        expect(parse(%q(%Q/1 {2} 3/))).must_equal s(:block, s(:str, "1 {2} 3"))
        expect(parse(%q(%Q[1 [2] 3]))).must_equal s(:block, s(:str, "1 [2] 3"))
        expect(parse(%q(%Q(1 (2) 3)))).must_equal s(:block, s(:str, "1 (2) 3"))
        ...
        expect(parse(%q("#{'a'}#{b}"))).must_equal s(:block, s(:dstr, "a", s(:evstr, s(:call, nil, :b))))
        expect(parse(%q("#{'a'}#{'b'}"))).must_equal s(:block, s(:str, "ab"))
      ...
      it 'parses op assignment' do
        ...
        if parser == 'NatalieParser'
          ...
          expect(parse("a.b *= c d")).must_equal s(:block, s(:op_asgn2, s(:call, nil, :a), :b=, :*, s(:call, nil, :c, s(:call, nil, :d))))
          expect(parse("a&.b *= c d")).must_equal s(:block, s(:safe_op_asgn2, s(:call, nil, :a), :b=, :*, s(:call, nil, :c, s(:call, nil, :d))))
          ...
          expect(parse("a&.b &&= c 1")).must_equal s(:block, s(:op_asgn_and, s(:safe_call, s(:call, nil, :a), :b), s(:safe_attrasgn, s(:call, nil, :a), :b=, s(:call, nil, :c, s(:lit, 1)))))
          expect(parse("a&.b ||= c 1")).must_equal s(:block, s(:op_asgn_or, s(:safe_call, s(:call, nil, :a), :b), s(:safe_attrasgn, s(:call, nil, :a), :b=, s(:call, nil, :c, s(:lit, 1)))))
        end
      end
      ...
      it 'parses word array' do
        ...
        expect(parse('%i[ foo#{1} bar ]')).must_equal s(:block, s(:array, s(:lit, :"foo\#{1}"), s(:lit, :bar)))
        expect(parse('%I[ foo#{1} bar ]')).must_equal s(:block, s(:array, s(:dsym, "foo", s(:evstr, s(:lit, 1))), s(:lit, :bar)))
      ...
      it 'parses block iter' do
        ...
        expect(parse("yield foo arg do |bar| end")).must_equal s(:block, s(:yield, s(:iter, s(:call, nil, :foo, s(:call, nil, :arg)), s(:args, :bar))))
        expect(parse("foo yield bar do |bar| end")).must_equal s(:block, s(:iter, s(:call, nil, :foo, s(:yield, s(:call, nil, :bar))), s(:args, :bar)))
        expect(parse("f ->() { g do end }")).must_equal s(:block, s(:call, nil, :f, s(:iter, s(:lambda), s(:args), s(:iter, s(:call, nil, :g), 0))))
        expect(parse("a [ nil, b do end ]")).must_equal s(:block, s(:call, nil, :a, s(:array, s(:nil), s(:iter, s(:call, nil, :b), 0))))
      ...
      it 'parses break, next, super, and yield' do
        ...
        expect(parse('foo { break }')).must_equal s(:block, s(:iter, s(:call, nil, :foo), 0, s(:break)))
        ...
        expect(parse('foo { next }')).must_equal s(:block, s(:iter, s(:call, nil, :foo), 0, s(:next)))
        ...
        expect(parse('foo { super }')).must_equal s(:block, s(:iter, s(:call, nil, :foo), 0, s(:zsuper)))
        ...
        expect(parse('foo { yield }')).must_equal s(:block, s(:iter, s(:call, nil, :foo), 0, s(:yield)))
      end
      ...
      it 'parses case/when/else' do
        ...
        expect(parse("case\nwhen true then :a\nelse :b\nend")).must_equal s(:block, s(:case, nil, s(:when, s(:array, s(:true)), s(:lit, :a)), s(:lit, :b)))
        expect(parse("case\nfoo; when 1; end")).must_equal s(:block, s(:case, s(:call, nil, :foo), s(:when, s(:array, s(:lit, 1)), nil), nil))
        expect(parse("case; when 1; end")).must_equal s(:block, s(:case, nil, s(:when, s(:array, s(:lit, 1)), nil), nil))
      ...
      it 'parses begin/rescue/else/ensure' do
        ...
        expect(parse("foo do;rescue;1;else;2;ensure;3;end")).must_equal s(:block, s(:iter, s(:call, nil, :foo), 0, s(:ensure, s(:rescue, s(:resbody, s(:array), s(:lit, 1)), s(:lit, 2)), s(:lit, 3))))
        expect(parse("foo do\n\nrescue\n1\nelse;2\nensure\n3\nend")).must_equal s(:block, s(:iter, s(:call, nil, :foo), 0, s(:ensure, s(:rescue, s(:resbody, s(:array), s(:lit, 1)), s(:lit, 2)), s(:lit, 3))))
        expect(parse("class Foo;rescue;1;else;2;ensure;3;end")).must_equal s(:block, s(:class, :Foo, nil, s(:ensure, s(:rescue, s(:resbody, s(:array), s(:lit, 1)), s(:lit, 2)), s(:lit, 3))))
        expect(parse("module Foo;rescue;1;else;2;ensure;3;end")).must_equal s(:block, s(:module, :Foo, s(:ensure, s(:rescue, s(:resbody, s(:array), s(:lit, 1)), s(:lit, 2)), s(:lit, 3))))
      end
